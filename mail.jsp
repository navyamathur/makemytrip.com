...
<%@ page import="javax.mail.internet.*" session="false"%>
<html>
<head>
...
<%   
{
	...
	{		
		...
		title="Message from Quicktrip";
		mymsg="your account has been opened with the id " + email + " and the password is "+ password;
	}
	...
	else //bill
	{
		...
		title="bill from Quicktrip";
		mymsg="Your goods including the invoice has been dispatched & amount you have to pay is " + amt;
	 }
	String host = "smtp.gmail.com";
	String from = "trip.quick123";//dummy mail 
	String pass = "quicktrip123";//dummy pass
